...
class AllTasksController extends GetxController {
  Future<void> addTask(Map<String, dynamic> taskData) async {
    try {
      await fireStore.collection(allTasks).add(taskData);
  ...
  Future<void> updateTask(String docId, Map<String, dynamic> updatedData) async {
    try {
      await fireStore.collection(allTasks).doc(docId).update(updatedData);
  ...
  Future<void> deleteTask(String docId) async {
    try {
      await fireStore.collection(allTasks).doc(docId).delete();
