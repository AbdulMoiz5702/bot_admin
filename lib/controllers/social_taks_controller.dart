...
class SocialTasksController extends GetxController {
  Future<void> addTask(Map<String, dynamic> taskData) async {
    try {
      await fireStore.collection(socialTasks).add(taskData);
  ...
  Future<void> updateTask(String docId, Map<String, dynamic> updatedData) async {
    try {
      await fireStore.collection(socialTasks).doc(docId).update(updatedData);
  ...
  Future<void> deleteTask(String docId) async {
    try {
      await fireStore.collection(socialTasks).doc(docId).delete();
