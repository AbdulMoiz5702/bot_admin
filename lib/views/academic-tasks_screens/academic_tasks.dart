import 'package:bot_admin/controllers/daily_tasks_controller.dart';
import 'package:bot_admin/services/firebase_services.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import '../../controllers/academic_tasks_controller.dart';


class AcademicTasksScreen extends StatelessWidget {
  const AcademicTasksScreen({super.key});

  @override
  Widget build(BuildContext context) {
    var controller = Get.put(AcademicTasksController());
    return Scaffold(
      appBar: AppBar(
        title: Text('Academic Tasks'),
      ),
      body: FutureBuilder<QuerySnapshot>(
        future: FirebaseServices.getAcademyTasks(),
